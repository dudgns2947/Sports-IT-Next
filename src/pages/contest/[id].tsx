  ...
  async function getContestDetail(id: number) {
    try {
      if (typeof window !== "undefined") {
        ...
        window.localStorage.setItem("selectCompetitionId", response.data.result.competitionId);
        setSelectContestName(response.data.result.name);
        window.localStorage.setItem("selectCompetitionName", response.data.result.name);
