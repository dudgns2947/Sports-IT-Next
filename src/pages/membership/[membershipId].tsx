            ...
            <div className="w-screen  bg-black flex flex-col items-center text-white pb-32">
                ...
                <div className="w-full pt-11 pl-5 pr-5">
                    <div className="flex flex-col gap-2">
                        <div className="text-3xl font-medium" style={{fontFamily : "Pretendard"}}>단체 회원으로</div>
                        <div className="text-3xl font-medium" style={{fontFamily : "Pretendard"}}>가입하시겠습니까?</div>
                    </div>
                    ...
                    <div className="flex flex-col gap-2">
                      <div className="w-full py-4 px-4 rounded-lg bg-[#212121] flex justify-between">
                            ...
                            <div className="">
                                <img src={"/join_membership/card.png"}></img>
                            </div>
                        </div>
                        <div className="w-full py-4 px-4 rounded-lg bg-[#212121] flex justify-between">
                            <div className="">
                            ...
                            <div className="">
                                <img src={"/join_membership/sale.png"}></img>
                            </div>
                        </div>
                        <div className="w-full py-4 px-4 rounded-lg bg-[#212121] flex justify-between">
                            <div className="">
                            ...
                            <div className="">
                                <img src={"/join_membership/community.png"}></img>
                            </div>
                        </div>                                      
                    </div>
                </div>
                <div className="flex fixed bottom-0 left-0 w-screen h-[6em] z-[100] bg-[#FD3446] text-white place-items-center">
                    <div className="w-full flex flex-col justify-center items-center">
                        <div className="pb-8 border-b-4 border-solid border-slate-200 font-medium"
